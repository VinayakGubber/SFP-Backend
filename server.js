...
/* Database connection for local setup using MySQL */
...
/* Database connection for AWS setup using RDS */
const pool = mysql.createPool({
  host: "studentfeedback.ch4g04mss5av.ap-south-1.rds.amazonaws.com", // ✅ your RDS endpoint
  user: "admin", // ✅ your RDS master username
  password: "admin7088", // ✅ your RDS password
  database: "StudentFeedback", // ✅ your DB name created in RDS
